...
{
    /*
        C++ has operators built into the language that allow us to assign values,
        compare values, do mathematics such as addition or subtraction, etc.
    ...
    */
    ...
    /*
        ...
        so 3 * 4 will be evaluated first, then 12 / 2 will then be evaluated.
    */
    int b = 3 * 4 / 2;
    ...
    /*
        ...
        then 3 * 2 will be the next evaluated, finally setting c to 6.
    */
    int c = 3 * (4 / 2);
