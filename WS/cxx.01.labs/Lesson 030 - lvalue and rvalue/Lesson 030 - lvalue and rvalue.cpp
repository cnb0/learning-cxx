...
int main()
{
    /*
        ...
        is required to complete the statement.
    ...
    */
    ...
    // So it's a simple matter of assigning the lvalue c to the rvalue generated
    // from a + b.
    //
    // Note that a + b = 0 would fail as the product of a + b is a rvalue.
    // Because the product of a + b is a rvalue (a temporary value),
    // it is not possible to assign a value to a rvalue object, hence we
    // cannot assign a value to a + b, which is why we cannot do a + b = 0.
    int c = a + b;
    ...
    // is allowed to take a rvalue and treat it as a lvalue, therefor
