...
// It's also valid to define: int main(int argc, char **argv)
{
    /*
        ...
        If you want to have access to the arguments passed to a program at a command line,
        which is common in a Windows prompt or Linux terminal, then main can access
        ...
        All other strings in argv would the values passed to your program
