...
// If we did not define a guard, then the header file could be included multiple times,
// and the class name would cause compiler problems with same class being defined
// multiple times.
// Once the guard has bee defined once, it cannot be defined again, and so any code
// between the guards will never be generated more than once.
#ifndef OCL_GUARD_TRAINING_LESSON_023_CLASSES_CONSTRUCTION_AND_DESTRUCTION_PERSON_HPP
#define OCL_GUARD_TRAINING_LESSON_023_CLASSES_CONSTRUCTION_AND_DESTRUCTION_PERSON_HPP
...
#endif // OCL_GUARD_TRAINING_LESSON_023_CLASSES_CONSTRUCTION_AND_DESTRUCTION_PERSON_HPP
