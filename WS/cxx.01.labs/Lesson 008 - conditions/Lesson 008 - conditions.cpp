...
int main()
{
    ...
    */
    ...
    /*
        The simplest form of conditional checking is the use of if and else.
    ...
    */
    ...
    /*
        The switch statement is generates more efficient executable code than using if else,
