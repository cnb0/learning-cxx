...
int main()
{
    ...
    */
    ...
    // This is because we have taken the returning reference from GetAddress and
    // asked for the address using & operator of the returned reference variable
    // (look back to earlier pointer training).
